...
RSpec.describe Reports::MonthlyPdf, type: :service do
  ...
  describe "content" do
    # PDF generation should use Prawn and must not depend on system packages.
    # These content assertions parse generated bytes with pdftotext from
    # poppler-utils, so CI must install that package if these specs become
    # mandatory.
    let(:pdf_text) do
